...
<?php echo form_open($searchAction);?>
	...
	<table style="width:80%;margin: auto;">
			<tr>	
				<td style="padding-left: 200px;">From : <?php echo form_input('stdate',$stdate);?> </td>
				<td style="padding-right: 200px;">To: <?php echo form_input('etdate',$etdate);?></td>
...
<?php $this->load->view('ledger/balancesheet/content.php');?> 
</div>
