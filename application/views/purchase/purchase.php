...
<body data-ng-app="myApp" data-ng-controller="purchaseController">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item" data-ng-repeat="item in order">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <input  class="form-control" data-ng-model="item.purchasePrice"/>
                                    </div>
                                    <div class="col-md-1">
                                       <input  class="form-control" data-ng-model="item.qty"/>
                                    </div>
                                    <div class="col-md-1">
