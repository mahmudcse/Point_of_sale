...
<body data-ng-app="myApp" data-ng-controller="saleController">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="panel panel-primary">
                	<div class="panel-body">
                	 	<div class="row">
                			<div class="col-md-4">
                				<label>Scan or input code:</label><br/>
								<form data-ng-submit="addByCode();">
									<input class="form-control" data-ng-model="tmpCode" placeholder="Scan barcode"  type="text"/>
								</form>
                			</div>
                			<div class="col-md-8">
                				<label>Select item:</label><br/>
							    
							    <selectize placeholder='Select  an item...' options="items" config="singleConfig" ng-model="itemId"></selectize>
                			</div>
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item" data-ng-repeat="item in order">
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="label label-warning">{{item.salePrice | currency:"":0}}</div>
                                    </div>
                                    <div class="col-md-1">
                                       <input style="width: 100%;" data-ng-model="item.qty"/>
                                    </div>
                                    <div class="col-md-1">
                                        <div class="label label-success">{{item.salePrice * item.qty | currency:"":0}}</div>
                                    </div>
                                    
                                    <div class="col-md-2">
                                        <button class="btn btn-success btn-xs" data-ng-click="addToOrder(item,1)">
                                            <span class="glyphicon glyphicon-plus"></span>
                                        </button>
                                        <button class="btn btn-warning btn-xs" data-ng-click="removeOneEntity(item)">
                                            <span class="glyphicon glyphicon-minus"></span>
                                        </button>
                                    </div>
                                    <div class="col-md-1 col-md-push-1">
                                        <button class="btn btn-danger btn-xs" data-ng-click="removeItem(item)">
            ...
            <div class="col-md-4">
            	<div class="panel-footer" >
                     ...
                     <div class="row  top-buffer">
                        	<div class="col-md-4"><span class="panel-title">Customer:</span></div>
                        	<div class="col-md-8">
            	...
            	<div class="panel-body" data-ng-show="order.length">
                	<div class="row"> 
               		...
               		<div class="row"> 
               			<div class="col-md-4"><span class="panel-title">Discount:</span></div>
            		...
            		<div class="row top-buffer"> 
            			...
            			<div class="col-md-8">{{paidAmount - getTotal()>0?paidAmount - getTotal():0.00 | currency:" ":0}}</div>
            		</div>-->
            	</div>
               <div class="panel-footer" data-ng-show="order.length">
                 	<div>
                  		...
                  		<span class="btn btn-danger btn-marginTop" data-ng-click="checkout()" data-ng-disabled="!order.length">Checkout</span>
